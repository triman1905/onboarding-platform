  ...
  return (
    ...
    >
      <PopoverTrigger asChild>
        ...
        >
          {preview || <span className="italic text-muted-foreground/60">Add remarks…</span>}
        </button>
      </PopoverTrigger>
      <PopoverContent className="w-80 space-y-2" align="start">
        <div className="text-xs font-semibold text-foreground">Remarks</div>
        <Textarea
          value={draft}
          onChange={(e) => setDraft(e.target.value)}
          rows={4}
          placeholder="e.g. Waiting for client confirmation. Follow up tomorrow."
        />
